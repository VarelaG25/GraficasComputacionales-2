...
public:
	TerrenoRR(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		CargaParametros(L"suelo1.jpg", L"hm.png", 50.0f);
	}
	...
	bool CargaParametros(WCHAR* diffuseTex, WCHAR* heightTex, float tile)
	{
		...
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"suelo1_normal.png", nullptr, nullptr, &normalTexture, nullptr);
		d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, L"suelo2.jpg", 0, 0, &colorMap2, 0 );
		d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, heightTex, 0, 0, &blendMap, 0 );
	...
	void Draw(D3DXMATRIX vista, D3DXMATRIX proyeccion)
	{
		...
		d3dContext->PSSetShaderResources(3, 1, &normalTexture);
